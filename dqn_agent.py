...
#         self.qnetwork_target = QNetwork(state_size, action_size, seed).to(device)
        self.qnetwork_local.load_state_dict(torch.load('/Users/sanketsans/Documents/Udacity/deepRL/deep-reinforcement-learning/p1_navigation/checkpoint.pth', map_location=torch.device('cpu')))
